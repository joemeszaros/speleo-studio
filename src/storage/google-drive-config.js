...
export class GoogleDriveConfig {
  ...
  getDefaultConfig() {
    return {
      ...
      folderName              : i18n.t('ui.panels.googleDriveSettings.folderNamePlaceholder'),
      cavesFolderName         : i18n.t('ui.panels.googleDriveSettings.cavesFolderPlaceholder'),
      projectsFolderName      : i18n.t('ui.panels.googleDriveSettings.projectsFolderPlaceholder'),
      modelsFolderName        : i18n.t('ui.panels.googleDriveSettings.modelsFolderPlaceholder'),
      modelFilesFolderName    : i18n.t('ui.panels.googleDriveSettings.modelFilesFolderPlaceholder'),
      textureFilesFolderName  : i18n.t('ui.panels.googleDriveSettings.textureFilesFolderPlaceholder'),
      modelMetadataFolderName : i18n.t('ui.panels.googleDriveSettings.modelMetadataFolderPlaceholder'),
      modelSettingsFolderName : i18n.t('ui.panels.googleDriveSettings.modelSettingsFolderPlaceholder'),
      autoSync           : false,
